        ...
        <nav class="navbar navbar-expand-md navbar-dark" style="background:#222255; color:#aaa;">
            <div class="container">
                ...
                <div class="user">
                    ...
                    ?>
                        <center>
                            <h6 style="text-transform: uppercase; color:#ffffff">สถานะ :&nbsp;<?php echo $_SESSION["status"]; ?>&nbsp;<i class="fas fa-user-cog" style="font-size: 18px; color: #46F700;"></i>
                                &nbsp;&nbsp;<a href="../php/logout.php" onclick="return confirm('ต้องการออกจากระบบ!');">ออกจากระบบ</a></h6>
                        </center>
                    <?php
                    } else {
                ...
                <div class="table-responsive">
                    <table id="datatable" class="table table-hover">
                        <thead class="thead" style="color: #fff; background-color: #007bff; border-color: #a1c5ec;">
                            ...
                            <th scope="col" nowrap>สถานะ</th>
                            <th scope="col" nowrap>ชื่อผู้ตอบคำถาม</th>
                            <th scope="col" nowrap>รายละเอียดคำตอบ</th>
                                    ...
                                    <td>
                                        <center>
                                            ...
                                            data-status="<?= $row['status']; ?>">
                                                <i class="fas fa-user-edit" data-toggle="tooltip" title="แก้ไข" style="font-size: 20px; color:green">&#xE254;</i></a>
                                        ...
                                        <div class="modal-content">
                                            <form enctype="multipart/form-data" method="POST" action="../php/update.php">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label>ช่องทางการรับข้อมูล</label><br>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input type="radio" id="status1" name="status" class="custom-control-input" value="ดำเนินการสำเร็จ" <?php if($row['status']=="ดำเนินการสำเร็จ"){ echo "checked";}?>>
                                                            <label class="custom-control-label" for="status1">ดำเนินการสำเร็จ</label>
                                                        </div>
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input type="radio" id="status2" name="status" class="custom-control-input" value="ยังไม่ดำเนินการ" <?php if($row['status']=="ยังไม่ดำเนินการ"){ echo "checked";}?>>
                                                            <label class="custom-control-label" for="status2">ยังไม่ดำเนินการ</label>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form method="POST" action="../php/delete.php">
                                                ...
                                                <div class="modal-body">
                                                    <p>ท่านต้องการลบข้อมูลใช่หรือไม่</p>
                                                    <p class="text-warning">
                                                        <small>ถ้าทำการดำเนินการลบข้อมูลแล้วจะไม่สามารถกู้คืนข้อมูลได้</small>
                                                    </p>
                                                    <input type="hidden" name="id" id="id">
                                                </div>
