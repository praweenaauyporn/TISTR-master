...
$sql = "SELECT * FROM master INNER JOIN experties ON (master.emp_id=experties.emp_id) INNER JOIN publication ON (master.emp_id=publication.emp_id)";
        ...
        <div class="container-fluid">
            <div class="lo-table">
                <div style="overflow-x:auto;">
                    <table id="datatable" class="table table-hover" style="width: auto;">
                        <thead class="thead" style="color: #fff; background-color: #007bff; border-color: #a1c5ec;">
                            <th scope="col" nowrap>รหัสพนักงาน</th>
                            ...
                            <th scope="col" nowrap>เรื่องตีพิมพ์</th>
                            <th scope="col" nowrap>สถานที่ตีพิมพ์</th>
                            <th scope="col" nowrap>หน้าที่</th>
                        </thead>
                        <tbody style="background-color: #FFFFFF; width:auto;">
                            <?php
                            while ($row = $result->fetch_assoc()) {
                            ?>
                                <tr scope="row">
                                    <td class="text-left" nowrap><?= $row['emp_id'] ?></td>
                                    <td class="text-left" nowrap><?= $row['emp_name'] ?></td>
                                    <td class="text-left"><?= $row['emp_job'] ?></td>
                                    <td class="text-left"><?= $row['emp_agency'] ?></td>
                                    <td class="text-left"><?= $row['emp_contact'] ?></td>
                                    <td class="text-left"><?= $row['emp_email'] ?></td>
                                    <td class="text-left"><?= $row['ep_name'] ?></td>
                                    <td class="text-left"><?= $row['pbc_title'] ?></td>
                                    <td class="text-left" ><?= $row['pbc_institute'] ?></td>
                                    <td class="text-left"><?= $row['pbc_position'] ?></td>
                                </tr>
                            <?php
                            }
